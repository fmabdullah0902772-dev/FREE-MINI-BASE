        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: "FM ABDULLAH",
                    serverMessageId: 1
                },
                externalAdReply: {
                    title: " *ABDULLH MEDIA ENGINE*",
                    body: "*Ready for dounload",
                    mediaType: 1,
                    renderLargerThumbnail: false,
                    thumbnailUrl: meta.thumbnail || meta.image,
                    sourceUrl: "https://whatsapp.com/channel/0029VbBwUOZ6BIEaxmYl3m1Z"
                }
            }
        }, { quoted: iosvCard });
